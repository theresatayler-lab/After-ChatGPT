...
export const ARCHETYPES = [
  {
    ...
    bio: `Born in London's West End, Shigg's childhood was steeped in poetry, music, and the gentle wisdom of everyday rituals. Her family's move to Dagenham in 1939, on the cusp of war, brought her into the heart of a new world—one of council estates, bomb shelters, and the constant chorus of birdsong above the city's shifting skyline. She survived the Blitz in the East End alongside her sisters and parents, finding strength in family and verse.

For Shigg, poetry was breath itself. The Rubáiyát of Omar Khayyám became her guiding star: its verses on impermanence, acceptance, and savoring the fleeting moment shaped her philosophy and daily practice. She quoted Khayyám as easily as she brewed tea, teaching that every dawn deserved a blessing and every sorrow a song. Her battered copy of the Rubáiyát, pages worn thin by war and worry, was her most cherished talisman.

Shigg's rituals were always poetic, always practical—a cup of tea sipped with intention, a sprig of rosemary for remembrance, a journal page for letting go. She believed in the magic of the mundane: that a line of verse could be a spell, and that the ordinary was always laced with wonder. Birds—zebra finches, cockatiels, magpies—were her constant companions and spiritual guides, their varied songs echoing the Rubáiyát's lessons of fleeting beauty and the importance of savoring each note.

Her spiritual lineage drew from the West End's vibrant arts and the wartime resilience of Dagenham. She saw the world as a Parliament of Birds—each voice unique, each perspective worthy, and harmony found in listening deeply to oneself and others. Devoted to Coronation Street, Shigg found kinship in the show's poetry of the ordinary: the heroism of daily life, the comfort of community, and the endurance of small joys.

She teaches how to let poetry steady your heart, how to use the Rubáiyát's wisdom as daily ritual—accepting what cannot be changed, savoring the present, and finding beauty in the briefest moments. She teaches you to listen for the parliament of your own soul, and to honor every feeling as a bird with its own song. Strength is found in gentleness, and every ritual—no matter how humble—can be an act of courage.`,
